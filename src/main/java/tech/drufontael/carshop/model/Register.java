...
import tech.drufontael.carshop.model.enums.RegisterType;
...
public class Register {
    ...
    public Register(String register){
        ...
        this.type=setRegisterType(numeros);
        this.register=this.type.equals(RegisterType.CPF)?cpfFormat(numeros):cnpjFormat(numeros);
    }
